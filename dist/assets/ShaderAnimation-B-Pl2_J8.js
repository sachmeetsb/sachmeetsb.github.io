import{r as c,j as w}from"./react-vendor-BwCPH1ty.js";import{a as y,b as x,P as E,c as b,V as R,d as j,W as F}from"./three-vendor-CQh6_-qO.js";function I({className:u="absolute inset-0"}){const o=c.useRef(null),e=c.useRef(null);return c.useEffect(()=>{if(!o.current)return;const n=o.current,v=`
      void main() {
