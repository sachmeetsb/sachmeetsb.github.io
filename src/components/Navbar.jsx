...
function Navbar() {
  ...
  const navAnimation = useSpring({
    backgroundColor: (isScrolled || isAboutPage) ? 'rgba(255, 255, 255, 0.95)' : 'rgba(255, 255, 255, 0.1)',
    backdropFilter: (isScrolled || isAboutPage) ? 'blur(20px)' : 'blur(10px)',
    boxShadow: (isScrolled || isAboutPage) 
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            className={`md:hidden p-2 rounded-lg backdrop-blur-md border transition-all duration-300 ${
              (isScrolled || isAboutPage)
          ...
          >
            <div className="w-6 h-6 flex flex-col justify-center items-center space-y-1">
              <div className={`w-4 h-0.5 bg-current transform transition-all duration-300 ${isMobileMenuOpen ? 'rotate-45 translate-y-1' : ''}`}></div>
